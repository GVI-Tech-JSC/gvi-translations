...
git clone https://github.com/GVI-Tech-JSC/ggvi-frontend frontend
...
cp -rf ggvi-frontend frontend/src/locales/translations/
...
export CI=false
echo "Build Tech Holding JSCDAP frontent web site "
