# Tech Holding JSC translations

## Translators
### How to become a translator

Join us on the Tech Holding JSC DAO discord server and introduce yourself in the #app-translations channel
...
```
# Clone the Tech Holding JSC frontend repository
git clone https://github.com/GVI-Tech-JSC/ggvi-frontend.git`
cd ggvi-frontend
...
# At this point your filesystem contains the latest ggvi-frontend develop branch with the latest olympus-translations develop branch as a submodule in src/locales/translations
